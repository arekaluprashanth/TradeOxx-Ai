              ...
              <div className="bg-dark-800 rounded-2xl p-6 border border-white/5">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-accent-cyan to-accent-purple flex items-center justify-center text-white text-xl font-bold shadow-glow-cyan">
                    {_optionalChain([user, 'optionalAccess', _ => _.name]) ? user.name.substring(0, 2).toUpperCase() : 'TS'}
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input 
                      type="text" 
                      defaultValue={_optionalChain([user, 'optionalAccess', _2 => _2.name]) || 'Trader'} 
                  ...
                  <div>
                    ...
                    <input 
                      type="email" 
                      defaultValue={_optionalChain([user, 'optionalAccess', _3 => _3.email]) || 'trader@tradeoxx.ai'} 
                      disabled
