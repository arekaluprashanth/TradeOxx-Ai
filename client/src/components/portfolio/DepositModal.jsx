            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-dark-300 leading-relaxed">
                  Launching secure portal to authorize your deposit of {formatCurrency(inputCurrency === 'INR' ? parseFloat(amount) / 83 : parseFloat(amount))}...
                </p>
              </div>
              <div className="p-3 bg-dark-850 rounded-2xl border border-white/5 font-mono text-[10px] text-dark-400">
                Safe tunnel active: HTTPS_AES_256_GCM
              </div>
            </motion.div>
          </div>
        )}
