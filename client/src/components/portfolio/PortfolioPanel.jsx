...
export default function PortfolioPanel() {
  ...
  const holdingsList = _optionalChain([portfolio, 'optionalAccess', _ => _.holdings]) || [];
  const totalValue = _nullishCoalesce(_optionalChain([portfolio, 'optionalAccess', _2 => _2.totalValue]), () => ( 100000));
  const dailyPL = _nullishCoalesce(_optionalChain([portfolio, 'optionalAccess', _3 => _3.dailyPnl]), () => ( 0));
  const totalPL = _nullishCoalesce(_optionalChain([portfolio, 'optionalAccess', _4 => _4.totalPnl]), () => ( 0));
  const availableCash = _nullishCoalesce(_optionalChain([portfolio, 'optionalAccess', _5 => _5.balance]), () => ( 50000));
