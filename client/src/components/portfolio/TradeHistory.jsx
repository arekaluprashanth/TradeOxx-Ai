...
export default function TradeHistory() {
  ...
  const filtered = useMemo(() => {
    return tradesList.filter((t) => {
      if (filterSymbol && !_optionalChain([t, 'access', _2 => _2.symbol, 'optionalAccess', _3 => _3.toLowerCase, 'call', _4 => _4(), 'access', _5 => _5.includes, 'call', _6 => _6(filterSymbol.toLowerCase())])) return false;
  ...
  const exportCSV = () => {
    ...
    const rows = sorted.map((t) => [
      ...
      _optionalChain([t, 'access', _7 => _7.pnl, 'optionalAccess', _8 => _8.toFixed, 'call', _9 => _9(2)]) || '0.00',
    ]);
